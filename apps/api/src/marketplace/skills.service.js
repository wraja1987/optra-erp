...
function registerSkill(appId, name, tokenCap) {
  return { appId, name, tokenCap, confirmCard: true, regulatedSubmit: AiGovernanceDefaults.regulatedSubmit };
}

function enforceSkillCall(skill, tokens) {
  return Number(tokens) <= Number(skill.tokenCap);
}
